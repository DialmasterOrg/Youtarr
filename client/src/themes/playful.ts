...
export const playfulTheme: ThemeDefinition = {
  ...
  tokens: {
    light: {
      ...
      'action-bar-padding-x': '0px',      'action-bar-foreground': '222 47% 11%',
      'action-bar-border': '214 32% 91%',
      'action-bar-hover-border': '222 47% 11%',
      'action-bar-disabled-foreground': '215 16% 47%',      'nav-hover-style': 'hard-shadow',
      'audio-chip-radius': 'var(--radius-ui)',
      'audio-chip-bg': 'var(--secondary)',
      ...
      'video-chip-bg': 'var(--primary)',
      'video-chip-border': 'var(--border-strong)',
      'video-chip-foreground': 'var(--primary-foreground)',
      'video-chip-icon': 'var(--primary-foreground)',
    ...
    dark: {
      ...
      'action-bar-gap-compact': '6px',
      'action-bar-padding-y': '8px',
      'action-bar-padding-x': '0px',      'action-bar-foreground': '48 100% 98%',
