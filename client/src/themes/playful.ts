...
export const playfulTheme: ThemeDefinition = {
  ...
  tokens: {
    light: {
      ...
      'nav-item-shadow-hover': 'var(--shadow-hard-hover)',      'chip-shadow-hover': 'none',      'nav-item-transform': 'translate(0, 0)',
    ...
    dark: {
      ...
      'action-bar-disabled-foreground': '215 16% 70%',      'nav-hover-style': 'hard-shadow',
      shadow: '48 100% 98%',
