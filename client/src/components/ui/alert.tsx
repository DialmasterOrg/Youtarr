    ...
    return (
      <div
        ...
        className={cn(
          ...
          config.classes,
          variant === 'standard' && `alert-standard alert-standard-${severity}`,
          variant === 'outlined' && `alert-outlined alert-outlined-${severity}`,
          variant === 'filled' && `alert-filled alert-filled-${severity}`,
          className
        )}
        {...props}
      >
