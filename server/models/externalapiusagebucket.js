...
ExternalApiUsageBucket.init({
  ...
  window_type: {
    ...
    allowNull: false,
    validate: { isIn: [['hour', 'day']] },
  },
  window_start: { type: DataTypes.DATE, allowNull: false },
  accepted_writes: { type: DataTypes.INTEGER, allowNull: false, defaultValue: 0 },
  ...
  indexes: [
    { unique: true, fields: ['api_key_id', 'window_type', 'window_start'], name: 'external_api_usage_key_window_uq' },
    { fields: ['window_start'], name: 'external_api_usage_window_idx' },
  ],
});
