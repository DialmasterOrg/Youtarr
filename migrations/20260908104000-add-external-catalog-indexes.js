...
const INDEXES = [
  ...
  ['channelvideos', ['youtube_removed', 'ignored', 'media_type', 'published_at'], 'channelvideos_external_candidates_idx'],
  ['channelvideos', ['youtube_removed', 'ignored', { name: 'media_type', length: 20 }, { name: 'published_at', length: 40 }, { name: 'youtube_id', length: 32 }, { name: 'channel_id', length: 64 }], 'channelvideos_external_catalog_seek_idx'],
