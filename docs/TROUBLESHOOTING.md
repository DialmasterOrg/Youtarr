...
3. Remember that servers define "watched" differently: Plex only reports a video watched once it's played to completion, while Jellyfin uses a configurable percentage. A video you stopped partway through may genuinely not be watched yet as far as the server is concerned.
