...
- **Volumes**:
  ...
  - `./config:/app/config` - Configuration files, the yt-dlp download archive (`complete.list`), and yt-dlp's cache (`.yt-dlp-cache/`, cleared automatically when yt-dlp updates; safe to delete)
